            ...
            <section class="ticketForm">
                <form>
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="ticketsVoorwaarde">
                            Hierbij verklaar ik dat ik het bedrag voor de hierboven aangegeven kaartjes zal over maken op: NL07 ASNB 0778 0951 69 (tnv F.E Poll) onder vermelding van mijn naam zodat mijn bestelling definitief wordt.
                        </label>
                    </div>
                    <div class="form-group">
